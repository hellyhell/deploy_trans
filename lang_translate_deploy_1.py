...
def predict_mod1(input_sentence,model):
  inputs = [tknizer_ita.word_index[i] for i in input_sentence.split(' ')]
...
query = 'tom era molto malato'
print("Italian sentence: ",query)

processed_query = preprocess_ita(query)

result = predict_mod1(processed_query,model)
print("Predicted English sentence: ",result)
